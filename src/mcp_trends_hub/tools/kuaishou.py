...
async def get_kuaishou_trending_func(args: dict) -> list:
    """获取快手热榜数据"""
    headers = {
...
kuaishou_tool_config = ToolConfig(
    name="get-kuaishou-trending",
    description="获取快手热榜，包含快手平台的热门短视频、热点话题及流行内容的实时热门中文资讯",
    func=get_kuaishou_trending_func,
)


async def get_tool_config() -> ToolConfig:
    """获取工具配置"""
    return await define_tool_config(kuaishou_tool_config) 